...
- `app.py` — the whole application: env loading, Google Sheets client, validation helpers, auth, and all routes (`/login`, `/logout`, `/`, `/submit`, `/delete`, `/edit`, `/stats`, `/currency`, `/currency/rates`).
